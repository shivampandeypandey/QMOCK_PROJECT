...
class Rentout extends Component {
  ...
  render() {
    ...
    if ((role === "Seller" && propertyCount === 0) || (role === "BestSeller")) {
      newPropertyButton = (
    ...
    if ((role === "Landlord") || (role === "BestSeller")) {
      if (role === "BestSeller") {
        rentPropertyButton = (
          <span>
            <span>
              ...
              <Row>
                ...
                <div className="col-7">
                  ...
                  <div className="propertyDetails">
                    ...
                    <div>
                      {"Rs. " + property.price + " | " + property.area + " sq. ft. | " + property.noOfBedrooms + " Bedrooms | " + property.noOfBathrooms + " Bathrooms"}
                    ...
                    {property.propertyType === PROPERTYRENT ? (
                      <div>
                        ...
                        <div>{"Security Deposit: Rs. " + property.securityDeposit}</div>
                      </div>
                    ) : ""}
