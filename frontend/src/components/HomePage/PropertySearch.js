  ...
  render() {
    ...
    if (this.state.properties) {
      propertyDetails = this.state.properties.map((propertyDetail) => {
        var BestSellerShow = true;
        if (localStorage.getItem("role") === "BestSeller") {
          if (propertyDetail.sellerId === localStorage.getItem("user_id")) {
            BestSellerShow = false;
          }
        }
        if (propertyDetail.propertyStatus === "Available" && BestSellerShow) {
          var Favbutton;
          ...
          return (
            <div class=" col-3" style={{ marginTop: "20px" }}>
                            ...
                            <div class="filters-row form-row" data-v-0bf4be34="">
                              ...
                              >
                                ...
                                >
                                  ...
                                  <option value="3500">Rs. 3,500</option>
                                  <option value="4000">Rs. 4,000</option>
                                  <option value="4500">Rs. 4,500</option>
                                  ...
                                  <option value="125000">Rs. 1250000</option>
                                  <option value="150000">Rs. 150,000</option>
                                  <option value="175000">Rs. 175,000</option>
                                  <option value="200000">Rs. 200,000</option>
                                  <option value="225000">Rs. 225,000</option>
                                  <option value="250000">Rs. 250,000</option>
                                  <option value="275000">Rs. 275,000</option>
                                  <option value="300000">Rs. 300,000</option>
                                  <option value="350000">Rs. 350,000</option>
                                  <option value="400000">Rs. 400,000</option>
                                  <option value="450000">Rs. 450,000</option>
                                  <option value="500000">Rs. 500,000</option>
                                  <option value="550000">Rs. 550,000</option>
                                  <option value="600000">Rs. 600,000</option>
                                  <option value="650000">Rs. 650,000</option>
                                  <option value="700000">Rs. 700,000</option>
                                  <option value="750000">Rs. 750,000</option>
                                  <option value="800000">Rs. 800,000</option>
                                  <option value="850000">Rs. 850,000</option>
                                  <option value="900000">Rs. 900,000</option>
                                  <option value="950000">Rs. 950,000</option>
                                  <option value="1000000">Rs. 1,000,000</option>
                                  <option value="1250000">Rs. 1,250,000</option>
                                  <option value="1500000">Rs. 1,500,000</option>
                                  <option value="1750000">Rs. 1,750,000</option>
